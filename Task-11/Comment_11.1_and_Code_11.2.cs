...
namespace Task_11
{
    internal class Comment
    {
        ...
        2. private class Product: IComparable, поля name, price, weight. Містить визначення методу public virtual void PriceChange 
        зміни ціни на задану кількість відсотків та public override string ToString, а також методів доступу до приватних полів
        класу. Реалізація його у вигляді interface недоречна, так як interface неможливо використовувати у типизованих списках.
